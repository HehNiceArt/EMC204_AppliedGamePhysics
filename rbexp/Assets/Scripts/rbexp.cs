...
public class rbexp : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            //Vector2 dragForce = -rb.velocity.normalized * dragCoefficient * rb.velocity.sqrMagnitude * rb.velocity.sqrMagnitude * rb.velocity.sqrMagnitude * rb.velocity.sqrMagnitude * rb.velocity.sqrMagnitude * rb.velocity.sqrMagnitude * rb.velocity.sqrMagnitude * rb.velocity.sqrMagnitude;
